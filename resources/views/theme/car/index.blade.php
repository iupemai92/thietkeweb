...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/colors.php?color=c85e51') }}" type="text/css" />
...
<body class="stretched side-push-panel" data-loader-html="<div><img src='../images/car/page-loader.gif' alt='Loader'></div>">
    ...
    <div id="wrapper" class="clearfix">
                ...
                <div class="container-fluid clearfix">
                    ...
                    <nav id="primary-menu" class="with-arrows clearfix">
                        <ul>
                                        ...
                                        <li>
                                            <div class="widget center clearfix">
                                                ...
                                                <div class="owl-carousel customjs image-carousel carousel-widget" data-margin="20" data-nav="false" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="4" data-items-lg="6" data-items-xl="6">
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/1.png" alt="Car">BMW 1 Series ActiveE</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/4.png" alt="Car">Mercedes-Benz S-Class</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/5.png" alt="Car">Gran Turismo</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/6.png" alt="Car">Mclaren 675LT SPIDER</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/7.png" alt="Car">Honda City</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/8.png" alt="Car">Toyota Qualis</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/9.png" alt="Car">Honda WR-V</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/10.png" alt="Car">Suzuki Breeza</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/2.png" alt="Car">Chevrolet Spark</a></div>
                                                    <div class="oc-item center"><a href="car-single.html"><img src="../images/car/mega-menu/3.png" alt="Car">Honda JaZZ</a></div>
                            ...
                            <li class="current"><a href="car-listing.html"><div>Car Listing</div></a></li>
        ...
        <!-- Page Title
        ============================================= -->
        <section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('../images/car/hero-slider/4.jpg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
                        ...
                        <form action="#" method="post" class="nobottommargin">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4 col-sm-6 col-12 mt-4 mt-md-0">
                                    <label for="">All Brands</label>
                                    <select class="selectpicker form-control customjs" title="Select Brand"  data-size="10" data-live-search="true" multiple data-live-search="true" style="width:100%;">
                                ...
                                <div class="col-md-4 col-sm-6 col-12 mt-4 mt-md-0">
                                    ...
                                    <select class="selectpicker customjs form-control" data-size="10" data-live-search="true" title="Select Model" style="width:100%; line-height: 30px;">
                                        <optgroup label="AUDI">
                        ...
                        <div id="portfolio" class="portfolio portfolio-3 grid-container clearfix" data-layout="fitRows">
                            ...
                            <article class="portfolio-item cf-sedan" style="padding-bottom: 40px">
                                <div class="portfolio-image">
                                    <a href="#">
                                        <img src="../images/car/filter-cars/1.jpg" alt="Open Imagination">
                            ...
                            <article class="portfolio-item cf-suv" style="padding-bottom: 40px">
                                <div class="portfolio-image">
                                    <a href="#">
                                        <img src="../images/car/filter-cars/2.jpg" alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price t700 ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                                        </div>
                            ...
                            <article class="portfolio-item cf-cabriolet" style="padding-bottom: 40px">
                                <div class="portfolio-image">
                                    <a href="#">
                                        <img src="../images/car/filter-cars/3.jpg" alt="Open Imagination">
                                        <div class="filter-p-pricing">
                            ...
                            <article class="portfolio-item cf-cuv">
                                <div class="portfolio-image">
                                    <a href="#">
                                        <img src="../images/car/filter-cars/4.jpg" alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price t700 ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                                        </div>
                            ...
                            <article class="portfolio-item cf-supercar">
                                <div class="portfolio-image">
                                    <a href="#">
                                        <img src="../images/car/filter-cars/5.jpg" alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price t700 ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                                        </div>
                            ...
                            <article class="portfolio-item cf-hatchback">
                                <div class="portfolio-image">
                                    <a href="#">
                                        <img src="../images/car/filter-cars/6.jpg" alt="Open Imagination">
                                        <div class="filter-p-pricing">
                                            <span class="p-price t700 ls1">$32,568</span>
                                            <span class="p-price-msrp">MSRP : <strong>$35,698</strong></span>
                                        </div>
                ...
                <div class="footer-widgets-wrap clearfix" style="padding: 30px;">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-5 fright tright col_last">
                            ...
                            <img src="../images/car/logo-footer.png" alt="" height="50" style="margin-top: ">
                            <br>
                            <div style="color: #444">
