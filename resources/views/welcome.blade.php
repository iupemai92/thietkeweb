        ...
        <div class="container clearfix center">
            ...
            <div id="portfolio" class="portfolio grid-container portfolio-nomargin clearfix">
                ...
                <article class="portfolio-item pf-illustrations">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="{{ asset('/images/portfolio/2.jpg') }}" alt="Locked Steel Gate">
                        </a>
                        <div class="portfolio-overlay">
                ...
                <article class="portfolio-item pf-graphics pf-uielements">
                    <div class="portfolio-image">
                        <a href="#">
                            <img src="{{ asset('/images/portfolio/3.jpg') }}" alt="Mac Sunglasses">
                        </a>
                        <div class="portfolio-overlay">
                ...
                <article class="portfolio-item pf-icons pf-illustrations">
                    <div class="portfolio-image">
                        <a href="#">
                            <img src="{{ asset('/images/portfolio/4.jpg') }}" alt="Mac Sunglasses">
                        </a>
                ...
                <article class="portfolio-item pf-uielements pf-media">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="{{ asset('/images/portfolio/5.jpg') }}" alt="Console Activity">
                        </a>
                        <div class="portfolio-overlay">
                ...
                <article class="portfolio-item pf-graphics pf-illustrations">
                    <div class="portfolio-image">
                        <a href="#">
                            <img src="{{ asset('/images/portfolio/6.jpg') }}" alt="Mac Sunglasses">
                        </a>
                        <div class="portfolio-overlay" data-lightbox="gallery">
                ...
                <article class="portfolio-item pf-uielements pf-icons">
                    <div class="portfolio-image">
                        <a href="portfolio-single-video.html">
                            <img src="{{ asset('/images/portfolio/7.jpg') }}" alt="Backpack Contents">
                        </a>
                        <div class="portfolio-overlay">
                ...
                <article class="portfolio-item pf-graphics">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="{{ asset('/images/portfolio/8.jpg') }}" alt="Sunset Bulb Glow">
                        </a>
                        <div class="portfolio-overlay">
                ...
                <article class="portfolio-item pf-illustrations pf-icons">
                    <div class="portfolio-image">
                        <a href="#">
                            <img src="{{ asset('/images/portfolio/9.jpg') }}" alt="Mac Sunglasses">
                        </a>
                        <div class="portfolio-overlay" data-lightbox="gallery">
                            <a href="{{ asset('/images/portfolio/full/9.jpg') }}" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                            <a href="{{ asset('/images/portfolio/full/9-1.jpg') }}" class="hidden" data-lightbox="gallery-item"></a>
                            <a href="{{ asset('/images/portfolio/full/9-2.jpg') }}" class="hidden" data-lightbox="gallery-item"></a>
                            <a href="portfolio-single-gallery.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                        </div>
                    </div>
                    <div class="portfolio-desc">
                ...
                <article class="portfolio-item pf-graphics pf-media pf-uielements">
                    <div class="portfolio-image">
                        <a href="portfolio-single-video.html">
                            <img src="{{ asset('/images/portfolio/10.jpg') }}" alt="Study Table">
                        </a>
                        <div class="portfolio-overlay">
                ...
                <article class="portfolio-item pf-media pf-icons">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="{{ asset('/images/portfolio/11.jpg') }}" alt="Workspace Stuff">
                        </a>
                        <div class="portfolio-overlay">
                            <a href="{{ asset('/images/portfolio/full/11.jpg') }}" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                            <a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                        </div>
                    </div>
                    <div class="portfolio-desc">
                ...
                <article class="portfolio-item pf-illustrations pf-graphics">
                    <div class="portfolio-image">
                        <a href="#">
                            <img src="{{ asset('/images/portfolio/12.jpg') }}" alt="Mac Sunglasses">
                        </a>
                        <div class="portfolio-overlay" data-lightbox="gallery">
                            <a href="{{ asset('/images/portfolio/full/12.jpg') }}" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                            <a href="{{ asset('/images/portfolio/full/12-1.jpg') }}" class="hidden" data-lightbox="gallery-item"></a>
                            <a href="portfolio-single-gallery.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                        </div>
                    </div>
                    <div class="portfolio-desc">
